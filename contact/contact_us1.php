...
if(isset($_POST['submit']))
{
    ...
    $mail->Username = "paragpatil91199@gmail.com"; // Your mail
    $mail->Password = 'paulstark11'; // Your password mail
    $mail->Port = 587; //specify SMTP Port
    $mail->SMTPSecure = 'tls';                               
    $mail->setFrom($_POST['email'],$_POST['name']);
    $mail->addAddress('paragpatil91199@gmail.com');
    ...
    {
        $result="Thanks\t" .$_POST['name']. " we'll get back in touch with you soon!";
    }
}
