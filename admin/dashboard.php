...
<br>
<span><a href="edit.php?id=<?php echo $row['id']; ?>"><i class="fa fa-pencil" aria-hidden="true"></i> Edit</a>| <a href="" id="<?php echo $row['id']; ?>" class="delete"><i class="fa fa-trash" aria-hidden="true"></i>Delete</a> | <a href=""><i class="fa fa-share" aria-hidden="true"></i> Share</a></span>
</li>
...
<br>
<span><a href="" class="approve" id="<?php echo $row['id'];?>"><i class="fa fa-thumbs-up" aria-hidden="true"></i> Approve</a></span>
</li>
<?php
